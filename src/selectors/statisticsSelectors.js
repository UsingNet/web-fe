...
export const checkFirstResponseTimeEmpty = createSelector(
  [getFirstResponsesPercents],
  (percents) => {
    let j = 0;
    for (let i = 0; i < percents.length; i++) {
      j += parseFloat(percents[i]);
    }
...
export const checkResponsesEmpty = createSelector(
  [getResponsesPercents],
  (percents) => {
    let j = 0;
    for (let i = 0; i < percents.length; i++) {
...
export const checkSessionsEmpty = createSelector(
  [getSessionsPercents],
  (percents) => {
    let j = 0;
    for (let i = 0; i < percents.length; i++) {
...
export const checkSourceEmpty = createSelector(
  [getFromList],
  (source) => {
    let j = 0;

    for (let i = 0; i < source.length; i++) {
      j += parseFloat(source[i].value);
    }
...
export const checkEvaluateEmpty = createSelector(
  [getEvaluateList],
  (source) => {
    let j = 0;
...
export const checkCategoryEmpty = createSelector(
  [getCategories],
  (source) => {
    let j = 0;
